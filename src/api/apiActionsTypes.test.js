...
it("fetch all actions types", () => {
  expect(createActionsTypes("user").FETCH_ALL_REQUEST).toBe("FETCH_USERS_REQUEST");
  expect(createActionsTypes("user").FETCH_ALL_SUCCESS).toBe("FETCH_USERS_SUCCESS");
  expect(createActionsTypes("user").FETCH_ALL_FAILURE).toBe("FETCH_USERS_FAILURE");
