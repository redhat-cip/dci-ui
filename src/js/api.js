...
.factory('api', ['$injector', function($injector) {
  ...
  api.getJobStatus = function(jobID) {
    var config = {'params': {'embed': 'jobdefinition,jobdefinition.jobdefinition_component', 'where': 'jobdefinition_id:' + jobID}};
    return $http.get(api.urls.jobs, config).then(_.property('data.jobs'));
  };

  api.getJobsAll = function() {
    var config = {'params': {'embed': 'jobdefinition,jobdefinition.jobdefinition_component' }};
    return $http.get(api.urls.jobs, config).then(_.property('data.jobs'));
  };
