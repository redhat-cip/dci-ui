...
test("team schema", t => {
  t.deepEqual(schemas.team, ["name", "email", "notification"]);
  t.deepEqual(schemas.teams, ["name", "email", "notification"]);
});
...
test("product schema", t => {
  t.deepEqual(schemas.product, ["name", "team_id", "description", "label"]);
