...
import { INewTopic, ITopic, ITopicForm, IProduct } from "types";
...
function fromTopicToTopicForm(topic: INewTopic): ITopicForm {
  return {
    ...topic,
...
function fromTopicFormToTopic(topic: ITopicForm): INewTopic | undefined {
...
interface TopicFormProps {
  topic?: ITopic;
  products: IProduct[];
  onSubmit: (topic: INewTopic | ITopic) => void;
}
