...
describe("admin topic edit component", function() {
  ...
  it("should init availableTeams with difference between teams and topicTeams", function() {
    expect(component.availableTeams.length).toBe(
      teams.length - osp10Teams.length
    );
  ...
  it("should associate team to topic teams", function() {
    ...
    $httpBackend
      .expectPOST(
        "https://api.example.org/api/v1/topics/d95c065a-fbc9-984c-8e9d-454d1a9171a7/teams",
        { team_id: 1 }
      )
      .respond();
  ...
  it("should remove team from topic teams", function() {
    ...
    $httpBackend
      .expectDELETE(
        "https://api.example.org/api/v1/topics/d95c065a-fbc9-984c-8e9d-454d1a9171a7/teams/2"
      )
      .respond();
