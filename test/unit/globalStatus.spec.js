...
describe("global status component", function() {
  ...
  it("getJobStatusClass", function() {
    expect(component.getJobStatusClass("new")).toBe("text-info");
    expect(component.getJobStatusClass("pre-run")).toBe("text-info");
    expect(component.getJobStatusClass("post-run")).toBe("text-info");
    expect(component.getJobStatusClass("failure")).toBe("text-danger");
    expect(component.getJobStatusClass("product-failure")).toBe("text-danger");
    expect(component.getJobStatusClass("deployment-failure")).toBe(
      "text-danger"
    );
    expect(component.getJobStatusClass("success")).toBe("text-success");
    expect(component.getJobStatusClass("killed")).toBe("text-warning");
  });
});
